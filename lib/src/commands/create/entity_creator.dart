...
class EntityCreatorCommand extends Command<void> {
  ...
  @override
  String get invocation => 'flutter_architect create entity <Name> [--feature <featureName>]';

  EntityCreatorCommand() {
    argParser.addOption(
      'feature',
      abbr: 'f',
      help: 'Feature this entity belongs to. If omitted, creates in lib/shared/entities/.',
    );
  }
