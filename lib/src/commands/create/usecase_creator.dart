...
class UsecaseCreatorCommand extends Command<void> {
  ...
  @override
  final String description = 'Generate a UseCase implementing the Callable Class pattern with error handling.';

  @override
  String get invocation => 'flutter_architect create usecase <Name> [--feature <featureName>]';
...
import '../repositories/${names.snakeCase}_repository.dart';
